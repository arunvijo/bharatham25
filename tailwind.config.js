  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        menuJumpIn: { "0%": { opacity: 0, transform: "translateY(100vh)" }, "100%": { opacity: 1, transform: "translateY(0)" } },
        menuJumpOut: { "0%": { opacity: 1, transform: "translateY(0)" }, "100%": { opacity: 0, transform: "translateY(100vh)" } },
      },
      animation: {
