...
const CreateParticipant = () => {
  ...
  const handleSaveParticipant = () => {
    if (!fullName || !uid || !branch || !semester || !house) {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg border-t-4 border-desi-saffron p-8 animate-fade-in-up">
          ...
          <div className="flex items-center gap-3 mb-8 border-b border-stone-100 pb-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-stone-800 font-reality tracking-wide">Add Participant</h2>
              <p className="text-sm text-stone-400">Enter student details for the event database</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                <option value="CSE Gamma">CSE Delta</option>
          ...
          <div className="flex justify-end gap-4 mt-8 pt-6 border-t border-stone-100">
            ...
            >
              <MdSave className="text-xl" /> Create Student
            </button>
          </div>
