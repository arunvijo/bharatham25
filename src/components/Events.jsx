...
import ScoreboardChart from "./ScoreboardChart.jsx";
...
export default function Events() {
  ...
  const events = [
    {
      title: "Pre Events",
      img: "/images/events/pre-events.svg",
      category: "PRE EVENTS",
      artist: "Aryasree Nambiar",
    },
    {
      title: "Group Events",
      img: "/images/events/group.svg",
      category: "GROUP EVENTS",
      artist: "Angel Rodrigues",
    },
    {
      title: "Combined Events",
      img: "/images/events/combined.svg",
      category: "COMBINED EVENTS",
      artist: "Neha Benny",
    },
    {
      title: "Individual Events",
      img: "/images/events/individual.svg",
  ...
  return (
    <section className="relative w-full bg-[#FDFBF7] text-stone-900 overflow-hidden">
      ...
      <div className="w-full relative z-10 -mt-1">
        <img src="/images/partition.svg" alt="" className="w-full h-auto" />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 relative z-10">
        ...
        >
          {events.map((event, index) => (
            ...
            >
              {/* IMAGE CONTAINER */}
              <HoverText text={`Art - ${event.artist}`}>
                <div
  ...
  "
      ...
      <section className="mx-auto w-full max-w-4xl relative">
        ...
        <div className="w-full bg-white border-4 border-stone-900 relative p-4 h-[600px] md:h-[700px]">
          <h2 className="text-3xl font-extrabold text-stone-900 text-center mb-6 border-b-2 border-stone-200 pb-3">
            <MdEmojiEvents className="inline text-desi-saffron" size={32} />{" "}
            House Standings
          </h2>
     ...
     */}
      ...
      {/* BOTTOM DECORATIVE SVG - need mt20 */}
