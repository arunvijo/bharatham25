...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[3000]">
      ...
      {/* MAIN NAVBAR CONTENT */}
      <nav
        className={`relative z-30 w-full px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between transition-all duration-200 ${
          isNavOpen ? "transparent" : "bg-[#FDFBF7]" // Solid cream background when closed
        }`}
      >
      ...
      {/* BOTTOM DECORATIVE SVG (Torn Paper Effect) */}
      <div 
        className={`w-full relative z-20 -mt-1 transition-opacity duration-300 pointer-events-none ${
      ...
      >
        <svg 
          ...
          style={{ fill: "#FDFBF7" }} // Matches the navbar cream background
