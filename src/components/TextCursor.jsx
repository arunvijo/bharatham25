...
export function SmoothCursor({
  ...
  useEffect(() => {
    // 1. Initial Setup: Hide default cursor globally
    ...
    const smoothMouseMove = (e) => {
      ...
      if (speed > 0.1) {
        ...
        // Reset scale after stopping
        const timeoutId = setTimeout(() => scale.set(1), 150)
    ...
    const checkHover = (e) => {
      ...
      // Hide Pink Cursor if interactive; Show otherwise
  ...
  return (
    <motion.div
      style={{
        ...
        rotate: rotation,
        scale: scale,
        zIndex: 9999, // Ensure it sits on top of most things but below modals if needed
